...
class Migration(migrations.Migration):
    ...
    replaces = [('hotel', '0001_initial'), ('hotel', '0002_initial'), ('hotel', '0003_initial')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hotel.villa_rooms')),
            ],
            options={
